...
public class DetailActivityUpcoming extends AppCompatActivity {

    private static final String URL_DATA = "https://api.themoviedb.org/3/movie/upcoming?api_key=cb3606bd72bdaa179217ab4e5a2d1348";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mPostJudul = getIntent().getExtras().getString("judul");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            Glide
                                    .with(DetailActivityUpcoming.this)

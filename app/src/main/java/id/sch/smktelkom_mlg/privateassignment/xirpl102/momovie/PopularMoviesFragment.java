...
import id.sch.smktelkom_mlg.privateassignment.xirpl102.momovie.adapter.PopularMoviesAdapter;
...
public class PopularMoviesFragment extends Fragment {
    ...
    private static final String URL_DATA = "https://api.themoviedb.org/3/movie/popular?api_key=cb3606bd72bdaa179217ab4e5a2d1348&language=en-US&page=1";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            adapter = new PopularMoviesAdapter(popularItems, getActivity().getApplicationContext());

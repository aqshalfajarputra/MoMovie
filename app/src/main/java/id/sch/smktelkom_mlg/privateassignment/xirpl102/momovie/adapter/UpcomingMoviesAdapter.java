...
import id.sch.smktelkom_mlg.privateassignment.xirpl102.momovie.DetailActivityUpcoming;
...
public class UpcomingMoviesAdapter extends RecyclerView.Adapter<UpcomingMoviesAdapter.ViewHolder> {
    ...
    private List<UpcomingItem> listItems;
    private Context context;

    public UpcomingMoviesAdapter(List<UpcomingItem> listItems, Context context) {
    ...
    public UpcomingMoviesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new UpcomingMoviesAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final UpcomingItem listItem = listItems.get(position);
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent singleBlogIntent = new Intent(context, DetailActivityUpcoming.class);
